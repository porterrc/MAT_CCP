...
function [z, xpierce,ypierce, seisout]  = ray_trace(Data,sname,stnx,stny,stel,dzi,z_max,sx,sy,sz,svmodel,vmodel,mxamp,mnamp,blim)
...
for i = 1:length(sname);
    if isfield(Data,char(sname(i)));
        ...
        [s_ind d]= knnsearch([SX,SY],[stnx(i),stny(i)]);
